...
"""
Description: Calculation of Euclidean Distance between pred tensor and tensor of correct outputs for loss calculation [I edited the first draft by GPT according to my needs]
Generated by: GPT-4
URL of Service: https://platform.openai.com/playground
"""
# Loss for feed forward networks
def ffn_loss_schedule(y_pred, input, outp_dict, max_y_train_len, device):
    batch_losses = []
    model_output_list = []
    ground_truth_list = []
...
def loss_schedule(y_pred, input, outp_dict, max_y_train_len, device):
    batch_losses = []
